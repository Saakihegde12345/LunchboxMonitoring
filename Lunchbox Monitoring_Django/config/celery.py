...
app.conf.beat_schedule = {
    ...
    # Generate sensor readings at configured interval
    'generate-sensor-readings': {
        'task': 'simulation.tasks.generate_sensor_readings',
        'schedule': getattr(settings, 'SIMULATION_READING_INTERVAL', 60.0),  # Default to 60 seconds if not set
    },

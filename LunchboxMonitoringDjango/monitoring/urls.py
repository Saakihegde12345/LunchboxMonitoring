...
urlpatterns = [
    ...
    path('lunchboxes/<int:lunchbox_id>/detail-data/', views.LunchboxDetailDataView.as_view(), name='lunchbox-detail-data'),
    path('lunchboxes/status/summary/', views.LunchboxStatusList.as_view(), name='lunchbox-status-summary'),
        ...
        # Device ingestion (switch from Ubidots direct -> Django)
        path('ingest/device/', views.DeviceIngestView.as_view(), name='device-ingest'),
    ])),
